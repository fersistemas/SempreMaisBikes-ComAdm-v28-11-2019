						...
						<table class="table">
							<thead>
								<tr> <!-- Tabela com as informações da tabela(db) modelo  -->
									<th style="text-align: center; vertical-align:middle !important" scope="col">Usuarios</th>
									<th style="text-align: center; vertical-align:middle !important" scope="col">Senhas</th>
									<th style="text-align: center; vertical-align:middle !important" scope="col">Tipo</th>
							...
							<tbody>
								...
								{
									echo '<tr>';
									echo '<td style="text-align: center; vertical-align:middle !important">'. $row['usuario'] . '</td>';
									echo '<td style="text-align: center; vertical-align:middle !important">'. $row['senha'] . '</td>';
									echo '<td style="text-align: center; vertical-align:middle !important">'. $row['tipo'] . '</td>';
									echo ' ';
